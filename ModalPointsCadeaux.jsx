        ...
        <div style={{ overflowY: 'auto', WebkitOverflowScrolling: 'touch', padding: '16px 24px 24px', flex: 1 }}>
          ...
          {onglet === 'explication' && (
            <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
              {[
                { icon: '📅', title: 'Limite quotidienne et mensuelle', desc: 'Tu peux gagner au maximum 5 points par jour et 150 points par mois.' },
                { icon: '🎫', title: 'Comment utiliser tes avantages', desc: 'Quand tu souhaites bénéficier de tes avantages, génère ton bon cadeau depuis ton profil.' },
                { icon: '🔄', title: 'Déduction des points utilisés', desc: 'Les points utilisés seront automatiquement déduits de ton crédit. Ton solde se met à jour en temps réel.' },
                { icon: '👤', title: 'Compte obligatoire', desc: 'Tu ne peux gagner des points que si tu as un compte StuDiscount. Crée ton compte gratuitement.' },
              ].map((item, i) => (
